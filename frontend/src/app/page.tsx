      ...
      <main className="pt-16">
          ...
          <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            >
              ...
              <h1 className="text-6xl md:text-7xl font-headline font-extrabold text-on-surface tracking-tighter leading-[1.05]">
                Syncing <span className="text-primary italic">employees</span>, managers, and finance.
              </h1>
              <p className="text-xl text-on-surface-variant max-w-xl leading-relaxed">
                Zync eliminates the bottleneck between submitting expenses and processing them. Submit receipts, track approvals, and automate reimbursements with zero friction.
              </p>
            ...
            >
              <div className="relative z-10 glass-card p-4 rounded-[2rem] shadow-2xl">
                ...
                <div className="absolute -bottom-6 -left-6 glass-card p-6 rounded-2xl max-w-[200px] shadow-xl">
                  <p className="text-sm font-bold text-primary mb-1">Approval Workflows</p>
                  <p className="text-xs text-on-surface-variant leading-tight">Optimized for lightning-fast corporate reimbursements.</p>
                </div>
              </div>
              {/* Decorative Orbs */}
            ...
            <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
              <div className="max-w-2xl">
                ...
                <p className="text-lg text-on-surface-variant">
                  We prioritize operational trust over generic forms. Zync uses an advanced role-based architecture to guarantee that managers and financial admins have total visibility.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              >
                <div>
                  ...
                  <h3 className="text-2xl font-headline font-bold mb-4">Role-Based Dashboards</h3>
                  <p className="text-on-surface-variant leading-relaxed max-w-md">
                    Avoid traditional spreadsheet chaos. Employees, Managers, and Finance Admins get dedicated experiences tailored exactly to what they need to securely access.
                  </p>
                </div>
              ...
              >
                <h3 className="text-2xl font-headline font-bold mb-6 italic leading-snug">"Fast approvals are not just about speed, but about operational trust and compliance."</h3>
                <div>
                  <p className="font-bold font-headline">Financial Security</p>
              ...
              >
                ...
                <h3 className="text-xl font-headline font-bold mb-3">Database-Native Receipts</h3>
                <p className="text-sm text-on-surface-variant leading-relaxed">
                  Attach PDFs and instantly link them natively into your PostgreSQL database. No more lost paper receipts or external bucket dependencies.
                </p>
              </motion.div>
              ...
              >
                <div className="flex-1">
                  <h3 className="text-xl font-headline font-bold mb-3">Transparent Audit Trails</h3>
                  <p className="text-sm text-on-surface-variant leading-relaxed">
                    Every submission, approval, routing change, and rejection is permanently logged in an immutable audit table for absolute enterprise compliance.
                  </p>
                </div>
        ...
        <section className="py-24 bg-surface">
          <div className="max-w-7xl mx-auto px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-headline font-extrabold tracking-tight mb-4 uppercase tracking-[0.2em] text-primary">Customer Success</h2>
            </div>
              ...
              {[
                {
                  ...
                  text: '"The transition from manual expense forms to Zync was a revelation. Our reimbursement payout time decreased by 40% as finance finally had total visibility."',
                ...
                {
                  name: "Marcus Rivers",
                  role: "Finance Director, Tech Labs",
                  text: '"The native database storage for PDF receipts is incredible. The strict audit logging makes corporate compliance audits so much easier."',
                ...
                },
                {
                  ...
                  role: "Operations Manager, Global IT",
                  text: '"Finally a system that understands the dynamic nature of corporate approvals. I can route expenses to key approvers with complete transparency."',
        ...
        <section className="py-20 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-8 text-center text-on-primary">
            <h2 className="text-3xl md:text-4xl font-headline font-extrabold tracking-tight mb-6">Ready to Sync Your Finances?</h2>
            <p className="text-lg text-primary-container mb-10 max-w-2xl mx-auto opacity-90 font-medium">
              Join over 12,000+ modern companies syncing employees, managers, and finance teams with Zync.
            </p>
      ...
      <footer className="w-full py-10 font-body text-[10px] uppercase tracking-widest bg-surface-container-low border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          <div className="text-slate-400">
            © {new Date().getFullYear()} Zync. All rights reserved.
          </div>
